...
from sb3_rnn.common.recurrent.buffers import RecurrentDictRolloutBuffer, RecurrentRolloutBuffer
from sb3_rnn.common.recurrent.policies import RecurrentActorCriticPolicy
from sb3_rnn.common.recurrent.type_aliases import RNNStates
from sb3_rnn.ppo_recurrent.policies import CnnRnnPolicy, MlpRnnPolicy, MultiInputRnnPolicy
...
class RecurrentPPO(OnPolicyAlgorithm):
    ...
    with support for recurrent policies (RNN).
    ...
    policy_aliases: Dict[str, Type[BasePolicy]] = {
        ...
        "CnnRnnPolicy": CnnRnnPolicy,
        "MultiInputRnnPolicy": MultiInputRnnPolicy,
    }
            ...
            for idx, done_ in enumerate(dones):
                if (
                    ...
                    with th.no_grad():
                        ...
                        # )
                        terminal_rnn_state = rnn_states.vf[:, idx: idx + 1, :].contiguous()
                        # terminal_rnn_state = None
                        episode_starts = th.tensor([False], dtype=th.float32, device=self.device)
                        terminal_value = self.policy.predict_values(terminal_obs, terminal_rnn_state, episode_starts)[
                            0]
